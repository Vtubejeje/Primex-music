...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      ...
      const supportServerLink = "https://discord.gg/cshxdjDd";
      ...
      const youtubeLink = "https://www.youtube.com/@Vtubeprime";
        const embed = new EmbedBuilder()
            ...
            .setAuthor({
              ...
              url: 'https://discord.gg/cshxdjDd'
          })
            .setDescription(`➡️ **Join our Discord server for support and updates:**\n- Discord - ${supportServerLink}\n\n➡️ **Follow us on:**\n- GitHub - ${githubLink}\n- YouTube - ${youtubeLink}`)
            .setImage('https://cdn.discordapp.com/attachments/1264507601614540882/1264507650226389005/letter-p-and-lightning-bolt-logo-design-template-png_30063.jpg')
            .setTimestamp();
